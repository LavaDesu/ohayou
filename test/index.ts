...
import { BeatmapSet } from "../src/Structures/API"; //TODO: get rid of this with classes or interfaces
    ...
    describe("Client", () => {
        ...
        describe("User", () => {
            ...
            it("#getUserRecent 4504101", async () => {
                ...
                expect(res.map(activity => activity.user.id)).to.be.an("array").and.to.include.members([ 4504101 ]);
            });
